      ...
      <section className="px-4 md:px-12 py-6 max-w-4xl mx-auto">
        <ClayCard className="p-6 md:p-8 overflow-hidden">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center shadow-inner text-blue-600">
              <Recycle className="w-7 h-7" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-700">Refill Prescription</h1>
              <p className="text-gray-500 text-sm md:text-base mt-1">Running low? Refill your existing medications quickly and easily.</p>
            </div>
          </div>
