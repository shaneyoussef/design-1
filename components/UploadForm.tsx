      ...
      <section className="px-3 md:px-12 py-4 md:py-6 max-w-4xl mx-auto">
        <ClayCard className="p-4 md:p-8 overflow-hidden">
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl bg-green-100 flex items-center justify-center shadow-inner text-green-600 flex-shrink-0">
              <Upload className="w-6 h-6 md:w-7 md:h-7" />
            </div>
            <div>
              <h1 className="text-xl md:text-3xl font-bold text-gray-700">Submit New Prescription</h1>
              <p className="text-gray-500 text-xs md:text-base mt-1">Upload a photo of your prescription and we'll take care of the rest.</p>
            </div>
          </div>
        ...
        <ClayCard className="p-4 md:p-6 mt-4 md:mt-6 bg-green-50/50">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-bold text-gray-700 mb-1 text-sm md:text-base">Tips for Uploading</h3>
              <ul className="text-gray-500 text-xs md:text-sm space-y-1">
